    ...
    def insertCSLL(self, value, location):
        if self.head is None:
            ...
            if location == 0:
                ...
                newNode.next = self.tail.next_value
    ...
    def traversalCSLL(self):
        if self.head is None:
            ...
            while tempNode:
                ...
                tempNode = tempNode.next_value
                if tempNode == self.tail.next_value:
                    break
        ...
        if self.head is None:
            ...
            if location == 0:
                ...
                while index < location - 1:
                    ...
                    index += 1
                nextNode = tempNode.next
                tempNode.next = nextNode.next_value
